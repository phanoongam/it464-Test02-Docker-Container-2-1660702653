...
$host = 'phanoo'; // แก้ไขให้ตรงกับค่าทีอยู่ใน Docker Compose หรือ .env
$user = 'phanoo'; // แก้ไขให้ตรงกับค่าที่อยู่ใน Docker Compose หรือ .env
$db   = 'phanoo'; // แก้ไขให้ตรงกับค่าที่อยู่ใน Docker Compose หรือ .env
